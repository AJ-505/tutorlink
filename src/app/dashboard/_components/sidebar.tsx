  ...
  const Nav = (
    <nav className="rounded-2xl bg-white/90 p-3 shadow-sm backdrop-blur">
      <div className="px-3 py-4">
        ...
        <div className="mt-2 inline-block rounded-full bg-indigo-100 px-2.5 py-1 text-xs font-semibold text-indigo-900">
        ...
        {items.map((i) => {
          ...
          return (
            <li key={i.href}>
              <Link
                href={i.href}
                className={`flex items-center gap-3 rounded-xl px-3 py-2 text-sm transition-colors ${active ? "bg-blue-100 text-neutral-900" : "text-neutral-700 hover:bg-neutral-100"}`}
