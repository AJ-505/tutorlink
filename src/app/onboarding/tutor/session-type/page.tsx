...
export default function TutorSessionType() {
  const preferredSessionTypes = useOnboardingStore(
    (s) => s.preferredSessionTypes,
  );
      ...
      <div className="mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
        <main className="mx-auto mt-10 max-w-2xl rounded-2xl bg-white/70 p-6 shadow-sm backdrop-blur sm:mt-14 sm:p-8">
          ...
          <p className="mb-6 text-neutral-600">
            Help our AI connect you with the right students by selecting your
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {SESSION_TYPES.map((type) => (
              <Chip
                key={type}
                selected={preferredSessionTypes.has(type)}
