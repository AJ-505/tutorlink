...
export default function TutorExperience() {
  ...
  const setYearsOfExperience = useOnboardingStore(
    (s) => s.setYearsOfExperience,
  );
      ...
      <div className="mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
        <main className="mx-auto mt-10 max-w-2xl rounded-2xl bg-white/70 p-6 shadow-sm backdrop-blur sm:mt-14 sm:p-8">
          ...
          <p className="mb-6 text-neutral-600">
            How many years of teaching experience do you have? This helps
            students understand your expertise level.
          </p>
